...
Nehmen wir an, wir interessieren uns für die Popularität der Namen Emma, Kimberly und Ruth. Wir reduzieren den Datensatz mit der `filter()`-Funktion, die ihr im vorherigen Kapitel kennengelernt habt, auf diese drei Namen:
