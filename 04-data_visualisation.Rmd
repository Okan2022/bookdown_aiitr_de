...
# Namen vergeben
data_streu$name <- "Vollmilchschokolade"
```
...
data8 <- rbind(data_streu, df_zartbitter)
```
...
```{r kap3_uebung_2b, eval=FALSE}
# Mittelwerte hinzufügen
```

c\. Gestalte den Plot ansprechend! Gib dem Plot einen aussagekräftigen Titel sowie aussagekräftige Beschriftungen für die x- und y-Achse, und experimentiere mit den Farben.

```{r kap3_uebung_2c, eval=FALSE}
# Plot gestalten
```
